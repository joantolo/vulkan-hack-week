...
void VulkanDebugger::init(VkInstance* instance)
{
    ...
    VulkanDebugger::debugCreateInfo.sType = VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT;
    VulkanDebugger::debugCreateInfo.messageSeverity = VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT |
                                                      VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT |
                                                      VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT;
    VulkanDebugger::debugCreateInfo.messageType = VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT |
...
{
    DestroyDebugUtilsMessengerEXT(*VulkanDebugger::instance, VulkanDebugger::debugMessenger, nullptr);
}

void VulkanDebugger::setupDebugMessenger()
{
    if (CreateDebugUtilsMessengerEXT(*VulkanDebugger::instance, &VulkanDebugger::debugCreateInfo, nullptr, &VulkanDebugger::debugMessenger) != VK_SUCCESS)
...
void VulkanDebugger::addRequiredExtensions(std::vector<const char*> &extensions)
{
